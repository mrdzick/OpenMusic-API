...
class PlaylistsService {
    ...
    async getSongsFromPlaylist (playlistId) {
        try {
            const result = await this._cacheService.get(`SongsIn:${playlistId}`)
            ...
            await this._cacheService.set(`SongsIn:${playlistId}`, JSON.stringify(result.rows))
